 ...
 */
public class GoalListviewFrag extends Fragment {
   ...
   private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.activity_goals_list, container, false);

        button= (Button) view.findViewById(R.id.buttonlist);
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Perform action on
                EditText editText= (EditText) view.findViewById(R.id.edittextlist);
